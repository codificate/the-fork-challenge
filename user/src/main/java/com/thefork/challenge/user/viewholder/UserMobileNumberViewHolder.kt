...
class UserMobileNumberViewHolder(private val view: View) : BaseUserInformationRowViewHolder(view) {
    ...
    companion object {
        fun create(layoutInflater: LayoutInflater, parent: ViewGroup): UserMobileNumberViewHolder {
            val inflatedView = layoutInflater.inflate(
                R.layout.user_information_item,
                parent,
                false
            )
            return UserMobileNumberViewHolder(
                inflatedView
            )
        }
    }
