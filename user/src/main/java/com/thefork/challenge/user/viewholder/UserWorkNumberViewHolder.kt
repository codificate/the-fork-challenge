...
class UserWorkNumberViewHolder(private val view: View) : BaseUserInformationRowViewHolder(view) {
    ...
    companion object {
        fun create(layoutInflater: LayoutInflater, parent: ViewGroup): UserWorkNumberViewHolder {
            val inflatedView = layoutInflater.inflate(
                R.layout.user_information_item,
                parent,
                false
            )
            return UserWorkNumberViewHolder(
                inflatedView
            )
        }
    }
